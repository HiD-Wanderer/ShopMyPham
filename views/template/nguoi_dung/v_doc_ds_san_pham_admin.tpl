              ...
              <table class="table table-striped">
                  ...
                  {foreach $DSSanPham as $itemSanPham}
              		<tr>
              		    ...
              		    <td>{$itemSanPham['trong_ngay']}</td>
              		    <td>
	              		    <a href="{$path}quan-tri/san-pham/cap-nhat-san-pham/{$itemSanPham['ma_san_pham']}" class="btn btn-info">Cập nhật</a>
	              		    <a href="{$path}quan-tri/san-pham/xoa-san-pham/{$itemSanPham['ma_san_pham']}" class="btn btn-warning">Xóa</a>
              		    </td>
              		</tr>
              		{$i=$i+1}
                  {/foreach}
